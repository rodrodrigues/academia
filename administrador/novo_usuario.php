      ...
      <body class="bg-dark">
        <div class="container">
          <div class="card card-login mx-auto mt-5">
            <div class="card-header">Cadastrar novo usário</div>
            <div class="card-body">
              <form class="" action="../requisicoesphp/cadastrar_novo_usuario.php" method="POST">
                <div class="form-group">
                  <label for="exampleInputPassword1">Nome</label>
                  <input class="form-control" id="exampleInputPassword1" type="text" name="nome_novo_usuario" placeholder="Digite o nome do usuário">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Telefone para contato</label>
                  <input class="form-control" id="exampleInputPassword1" type="text" name="telefone_novo_usuario" placeholder="Digite o telefone do usuário">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Email</label>
                  <input class="form-control" id="exampleInputEmail1" type="text" name="email_novo_usuario" value="" placeholder="Digite o e-mail do usuário">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Endereço</label>
                  <input class="form-control" id="exampleInputEmail1" type="text" name="endereco_novo_usuario" value="" placeholder="Digite o e-mail do usuário">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Senha</label>
                  <input class="form-control" id="exampleInputPassword1" type="password" name="senha_novo_usuario" placeholder="Digite sua nova senha">
                </div>
                <div class="form-group">

                </div>
                <input class="btn btn-primary btn-block" type="submit" name="enviar" value="Cadastrar">
              </form>
