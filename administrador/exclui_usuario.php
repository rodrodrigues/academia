...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      <center>
        <h1>Você está excluindo o usuário, <?= $_SESSION['nomuser'] ?>,  de matricula: <?= $_SESSION['matuser'] ?></h1>
      </center>
          ...
          <div class="card card-login mx-auto mt-5">
            ...
            <div class="card-body">
              <form class="" action="../requisicoesphp/excluir_usuario.php" method="POST">
                ...
                <input class="btn btn-primary btn-block" type="submit" name="enviar" value="Excluir">
                <center>
