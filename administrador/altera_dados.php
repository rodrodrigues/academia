      ...
      <body class="bg-dark">
        <div class="container">
          <div class="card card-login mx-auto mt-5">
            <div class="card-header">Alterar Dados do Usuário</div>
            <div class="card-body">
              <form class="" action="../requisicoesphp/alterar_dados_de_usuario.php" method="post">
                <div class="form-group">
                  <label for="exampleInputEmail1">Nome</label>
                  <input class="form-control" id="exampleInputEmail1" type="text" name="attnome" value="" placeholder="Digite o novo nome do Usuário">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Email</label>
                  <input class="form-control" id="exampleInputEmail1" type="text" name="attemail" value="" placeholder="Digite o novo email do Usuário">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Peso</label>
                  <input class="form-control" id="exampleInputEmail1" type="text" name="attpeso" value="" placeholder="Digite seu novo e-mail">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Altura</label>
                  <input class="form-control" id="exampleInputPassword1" type="text" name="attaltura" placeholder="Digite sua nova senha">
                </div>
                <div class="form-group">
