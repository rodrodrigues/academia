      ...
      <body class="bg-dark">
        <div class="container">
          <div class="card card-login mx-auto mt-5">
            ...
            <div class="card-body">
              <form class="" class="" action="../requisicoesphp/buscar_usuario.php" method="post">
                <div class="form-group">
                  <label for="exampleInputPassword1">Matrícula</label>
                  <input class="form-control" id="exampleInputPassword1" type="text" name="matricula" placeholder="Digite o nome do usuário">
                </div>
